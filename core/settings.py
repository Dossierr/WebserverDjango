...
ALLOWED_HOSTS = ['.amazonlightsail.com','.dossierr.com','dossierr.com', 'localhost', '0.0.0.0', '127.0.0.1',]
CSRF_TRUSTED_ORIGINS = ['https://localhost','https://*.amazonlightsail.com','https://127.0.0.1', 'https://dossierr.com']
